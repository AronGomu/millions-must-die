...
pub use fixtures::{
    ...
    FIXTURE_CORRIDOR_V1, FIXTURE_DENSE_V1, FIXTURE_DIR, FIXTURE_RTS_COMBAT_V1, FIXTURE_SMALL_V1,
    FIXTURE_WALLED_V1, GATE_SCENARIO, RTS_SCENE, fixture_path, gate_scenario_path, rts_scene_path,
    scene_path,
};
