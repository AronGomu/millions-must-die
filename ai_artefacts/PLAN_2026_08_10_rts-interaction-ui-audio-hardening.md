...
- Confirmed decisions: `../ai-artifacts/GRILL_2026_08_10_rts-feedback/ANSWERS.md`.
- Plan artifacts use requested `ai_artefacts/`; existing repo agent artifacts remain in `ai-artifacts/`.
