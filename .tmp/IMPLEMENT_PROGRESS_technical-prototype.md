...
| T29 | Deterministic system test harness | done | PENDING_SHA | `mmd_engine::testkit::Harness` is the one seeded headless entry point; cross-process hash proof; 2 tracked fixtures; sim/nav suites migrated with full assertion parity |
