...
| T28 | Retire perf gating | done | PENDING_SHA | perf gating retired: docs/05-testing.md is the single gate source of truth; bench/lab frozen in place (nothing deleted/moved), only gating authority removed |
