...
| T30 | Simulation + navigation behaviour | done | PENDING_SHA | 8 new behaviour tests + 2 tracked fixtures; all 12 injected regressions killed their target test; no engine bug surfaced |
