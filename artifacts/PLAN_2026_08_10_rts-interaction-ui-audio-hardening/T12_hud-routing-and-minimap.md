...
- [ ] manual check: minimap/card/icon clicks work; bottom-panel gaps never select/order world — left for a human (no window on this desktop, per worker constraint); logged in `artifacts/manual_test_checklist.md`.
