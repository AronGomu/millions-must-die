...
- [ ] manual check: single/multi selections show expected center panel; worker/HQ/Barracks card changes — left for a human (`artifacts/manual_test_checklist.md`, `## T11 starcraft-hud-layout`).
