...
- [x] manual check: box-select six workers; right-click ground/node/site → visible spread, no merge — criterion: appended as unchecked steps to `artifacts/manual_test_checklist.md` under `## T5 formations-and-fair-chokes`.
