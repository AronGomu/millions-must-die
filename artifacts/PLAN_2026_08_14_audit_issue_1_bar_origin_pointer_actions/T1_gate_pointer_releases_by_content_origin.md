...
**Plan:** `./artifacts/PLAN_2026_08_14_audit_issue_1_bar_origin_pointer_actions.md`
**Depends:** none
...
- `artifacts/manual_test_checklist.md`: `## T8 aspect-fit-canvas`; edit one item.
- **From Depends:** none.
...
- [ ] 14. Add one unchecked item directly after T8 bar-click item in `artifacts/manual_test_checklist.md`: press left in bar, move into content, release over unit/HUD/placement; repeat with Shift plus right button; expect no selection/placement/HUD/cancel/order; repeat down/move/up fully inside; expect normal actions.
- [ ] 15. Inspect diff for scope. Criterion: implementation touches only `src/rts_run.rs`, `artifacts/manual_test_checklist.md`; no viewport/script/focus-policy refactor.
...
- `artifacts/manual_test_checklist.md`: one T8 bar-origin gesture check.
- Public API: none.
...
- [ ] Review `artifacts/manual_test_checklist.md` T8 addition. Criterion: human can reproduce letterbox/pillarbox origin cases plus valid controls; do not claim live result unless human runs it.
